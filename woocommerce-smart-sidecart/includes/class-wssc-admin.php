...
public function requests_page() {
    ...
    // Enqueue the admin JS specifically for this page
    wp_enqueue_script('wssc-admin-requests', WSSC_PLUGIN_URL . 'assets/js/wssc-admin-requests.js', ['jquery'], null, true);
    wp_localize_script('wssc-admin-requests', 'wsscAdminRequests', [
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('wssc_admin_requests_nonce')
    ]);
    ?>
        <div class="wrap">
            <h1>Bulk Requests</h1>
